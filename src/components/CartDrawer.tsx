...
const CartDrawer = () => {
  const { cart, removeFromCart, updateQuantity, total, grandTotal, selectedShipping, isCartOpen, closeCart } = useCart();
          ...
          {cart.length > 0 && (
            <div className="p-6 border-t bg-white space-y-3">
              <div className="space-y-1.5 text-sm">
                ...
                <div className="flex justify-between items-center text-lg font-bold text-slate-900 border-t pt-2 mt-1">
                  <span className="uppercase tracking-wider">Total</span>
                  <span className="text-2xl font-extrabold">R$ {grandTotal.toFixed(2)}</span>
                </div>
              </div>
